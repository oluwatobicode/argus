...
import { ERR_POOL, clock } from "./Hero";
...
export function Features() {
  ...
  return (
    <>
      {/* SDK cards */}
      <section className="relative mx-auto w-[min(1180px,calc(100%_-_40px))] pt-6 pb-20">
        ...
        <div className="grid grid-cols-2 gap-3.5 sm:grid-cols-3 lg:grid-cols-5">
          {SDKS.map((s) => (
            <div
              key={s.name}
              className="flex flex-col items-center gap-1.5 border border-[#343843] bg-[rgba(17,19,24,0.72)] px-3.5 py-[26px] transition-colors hover:border-lime/45"
            >
              <div className="mb-2">{s.icon}</div>
              <div className="text-[14.5px] font-bold text-[#e7e8ee]">{s.name}</div>
              <div className="font-code text-[11px] text-[#5a5f6d]">{s.sub}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* DX bento */}
      <section id="features" className="relative mx-auto w-[min(1180px,calc(100%_-_40px))] pt-[50px]">
        <h2 className="mb-[54px] font-display text-[34px] leading-[1.12] font-extrabold md:text-[40px]">
          First-class
          <br />
        ...
        <div className="grid items-stretch gap-4 md:grid-cols-2">
          <div className="grid gap-4">
            {/* one-line setup */}
            <div className="flex flex-col border border-[rgba(52,56,67,0.85)] bg-[rgba(17,19,24,0.78)] p-[30px] shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
              ...
              <div className="mt-auto border border-[rgba(52,56,67,0.72)] bg-[#08090c] px-[18px] py-4 font-code text-[13px]">
                <span className="text-lime">$</span>{" "}
                <span className="text-[#e7e8ee]">npm install @argusdev/sdk-browser</span>
              </div>
            </div>
            ...
            <div className="flex flex-col border border-[rgba(52,56,67,0.85)] bg-[rgba(17,19,24,0.78)] p-[30px] shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
              ...
              <div className="mt-auto overflow-hidden border border-[rgba(52,56,67,0.72)] bg-[#08090c]">
                ...
                <div className="min-h-[118px] px-[18px] py-4 font-code text-[12.5px] leading-[1.9]">
          ...
          {/* live feed */}
          <div className="relative flex flex-col overflow-hidden border border-[rgba(52,56,67,0.85)] bg-[rgba(17,19,24,0.78)] p-[30px] shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
            ...
            <div className="mt-auto flex flex-col gap-[9px] pt-6">
              {feed.map((f) => (
                <div
                  key={f.id}
                  className="flex animate-[landing-slidein_0.4s_ease] items-center gap-3 border border-[rgba(52,56,67,0.72)] bg-[#08090c] px-[15px] py-3 font-code text-[11.5px]"
                >
                  ...
                  <span className="flex-none text-[#5a5f6d]">{f.route}</span>
                </div>
              ))}
            </div>
          </div>
