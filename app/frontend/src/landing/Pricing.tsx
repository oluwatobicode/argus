...
export function Pricing() {
  return (
    <section id="pricing" className="relative mx-auto w-[min(1180px,calc(100%_-_40px))] pt-28">
      <div className="mx-auto mb-[50px] max-w-[640px] text-center">
        ...
        <h2 className="font-display text-[30px] font-extrabold md:text-[36px]">
          Free to start. Fair to scale.
        </h2>
        <p className="mt-[18px] font-code text-[14px] text-[#9699a6]">
      ...
      <div className="mx-auto grid max-w-[760px] gap-4 md:grid-cols-2">
        {/* Free */}
        <div className="border border-[rgba(52,56,67,0.85)] bg-[rgba(17,19,24,0.78)] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
          <div className="text-base font-extrabold">Free</div>
          <div className="mt-3.5 mb-1.5 font-code text-[44px] font-bold tracking-[-0.02em]">
        ...
        {/* Pro */}
        <div className="relative border border-lime/50 bg-lime/[0.07] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
          <span className="absolute top-[22px] right-[26px] bg-[#ff4f9a] px-[11px] py-1 font-code text-[10px] font-bold text-[#08090c]">
            POPULAR
          </span>
